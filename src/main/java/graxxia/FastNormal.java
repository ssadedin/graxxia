 ...
 */
public class FastNormal extends AbstractRealDistribution {
    /**
    ...
    private final static double HALF_LOG_2_TIMES_PI = 0.5 * FastMath.log(2 * FastMath.PI);
     ...
     */
    public FastNormal(double mean, double sd)
     ...
     * @since 2.1
     */
    public FastNormal(double mean, double sd, double inverseCumAccuracy)
        throws NotStrictlyPositiveException {
     ...
     * @since 3.3
     */
    public FastNormal(RandomGenerator rng, double mean, double sd)
        throws NotStrictlyPositiveException {
     ...
     * @since 3.1
     */
    public FastNormal(RandomGenerator rng,
                              double mean,
                              double sd,
        ...
        logStandardDeviationPlusHalfLog2Pi = FastMath.log(sd) + HALF_LOG_2_TIMES_PI;
